...
-- Helper: Convert relative URL to absolute (no utils.lua dependency)
...
-- Helper: Build proxied URL for segments/playlists (no utils.lua dependency)
local function build_proxy_url(abs_url, proxy_type)
    local endpoint = proxy_type .. (proxy_type == "ts-proxy" and ".ts" or ".m3u8")
